...
{
    public static List<string> GetData(Random random)
    {
        var basePhrases = new List<string>(120)
        {
            "the quick brown fox",
    ...
    private static string GenerateVariation(string basePhrase, Random random)
    {
